...
const AdminDashboard = () => {
        ...
        openDeleteModal(
          ...
          async () => {
            try {
              ...
              if (data.success) {
                showAlert("success", "Test order created successfully", "Success");
                fetchDashboardData();
              } else {
                showAlert("failure", data.message || "Failed to create order", "Error");
              }
            } catch (error) {
  ...
  const handleDeleteConfirm = async () => {
    ...
    setShowDeleteModal({ isOpen: false, title: "", message: "", confirmText: "", onConfirm: null });
  };
  ...
  return (
    <>
      ...
      <CancelConfirmationModal
        ...
        title="Cancel Action"
        message={`Are you sure you want to cancel ${actionToCancel || "this action"}?`}
